...
class lit_llama():
    def __init__(self,
        ...
        if not checkpoint_path:
            checkpoint_path = Path(f"/home/zeus/content/Comparing_LLM_Blogpost/checkpoints/lit-llama/{model_size}/state_dict.pth")
    ...
    def generate(self, prompt: str = "Hello, my name is",
